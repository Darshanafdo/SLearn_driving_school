...
<head>
    ...
    <link rel="stylesheet" href="../CSS/Body/S_login.css">
...
<body>
    ...
    <header>
        ...
        <nav class="nav">
            ...
            <ul class="nav-links">
                <li><a class="active" href="home.html"><i class="uil uil-estate"></i> Home</a></li>
                ...
                <li><a href="S_login.html"><i class="uil uil-sign-in-alt"></i> Login </a></li>
                <li><a class="action_btn" href="S_login.html">Get Started <i class="uil uil-forward"></i></a></li>
            </ul>
    ...
    <div class="dropdown_menu" id="dropdownMenu">
        <ul class="nav-links">
            <li><a class="active" href="../index.html"><i class="uil uil-estate"></i> Home</a></li>
            <li><a href="../pages/About_us.html"><i class="uil uil-comment-info"></i> About us</a></li>
            <li><a href="Packages Details.html"><i class="uil uil-package"></i> Packages</a></li>
            <li><a href="../PHP/contact_us.php"><i class="uil uil-phone-pause"></i> Contact</a></li>
            <li><a href="S_login.html"><i class="uil uil-sign-in-alt"></i> Login </a></li>
            <li><a class="action_btn" href="S_login.html">Get Started <i class="uil uil-forward"></i></a></li>
        </ul>
    </div>
        ...
        <div class="container">
            <div class="box">
                ...
                <form action="registration.php" method="post">
                    ...
                    <p class="form-footer">Already have an account? <a href="S_login.html">Login here</a>.</p>
                </form>
            </div>
        </div>
